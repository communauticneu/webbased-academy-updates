...
test('Academy chalk surface uses the supplied full-resolution reference crop, stays flat and has no synthetic frame',()=>{
  const css=read('src/presentation-stage-v16.17.css');
  ...
  assert.match(board,/background-position:left 71%!important/);
