...
test('V0.16.23 uses a compact short-height mode so editor and media stay fully visible without vertical scrolling',()=>{
  ...
  assert.match(js,/\.v1623-scene-editor\{overflow-y:hidden!important;padding:8px!important\}/);
  assert.match(js,/\.v1623-editor-meta\{margin-bottom:6px!important\}/);
  assert.match(js,/\.v1623-editor-body label\{margin:3px 0 2px!important\}/);
  assert.match(js,/\.v1623-editor-body input,\.v1623-editor-body select\{padding:5px 6px!important\}/);
  assert.match(js,/\.v1623-section\{margin-top:6px!important;padding-top:6px!important\}/);
  assert.match(js,/\.v1623-media-workspace\{height:132px!important;min-height:132px!important\}/);
  assert.match(js,/\.v1623-media-workspace \.media-item\{min-height:68px!important\}/);
  assert.match(js,/\.v1623-media-workspace \.media-item \.thumb\{height:38px!important\}/);
});
